...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://repair-shop-backend.herokuapp.com',
...
var authTemplate = __webpack_require__(11);
...
var signOutSuccess = function signOutSuccess() {
  ...
  $('.navbar-toggle').hasClass('collapsed') ? '' : $('.navbar-toggle').click();
...
var onShowChangePW = function onShowChangePW() {
    clearContent();
...
var onSignOut = function onSignOut(event) {
    ...
    authAPI.signOut().then(authUI.signOutSuccess).catch(authUI.failure);
};

// DEVICES
var onShowDevices = function onShowDevices() {
    debugger;
    clearContent();
    $('.wrapper-devices').css('display', 'block');
};

var onShowMyDevices = function onShowMyDevices() {
    clearContent();
    api.myDevices().then(ui.myDevicesSuccess).catch(ui.failure);
};

var onShowAddDevice = function onShowAddDevice() {
    clearContent();
    $('.wrapper-add-device').css('display', 'block');
};

var onAddDevice = function onAddDevice(event) {
    event.preventDefault();
    var data = getFormFields(event.target);

    api.addDevice(data).then(onShowMyDevices).catch(ui.failure);
};

// EDIT
var onShowEditDevice = function onShowEditDevice(event) {
    event.preventDefault();
    clearContent();
    var template = void 0,
        target = $(event.target).parents('ul').attr('data-id');
    store.devices.forEach(function (device) {
        if (device.id == target) {
...
var onEditDevice = function onEditDevice(event) {
    event.preventDefault();
    var data = getFormFields(event.target);
    var deviceId = $(event.target).closest('div').attr('data-id');

    api.editDevice(data, deviceId).then(onShowMyDevices).catch(ui.failure);
};

//  DELETE
var onDeleteDevice = function onDeleteDevice(event) {
    event.preventDefault();
    var deviceId = $(event.target).closest('ul').attr('data-id');
    api.deleteDevice(deviceId).then(onShowMyDevices).catch(ui.failure);
};

// REPAIRS
var onRepairOrder = function onRepairOrder(event) {
    event.preventDefault();
    var data = getFormFields(event.target);
    // console.log(data)
    api.createRepair(data).then(clearContent).then(ui.createRepairSuccess).catch(ui.failure);
};

var onShowRepairOrder = function onShowRepairOrder(event) {
    clearContent();
    var template = void 0,
        target = $(event.target).parents('ul').attr('data-id');
    store.devices.forEach(function (device) {
...
var onShowMyRepairs = function onShowMyRepairs() {
    clearContent();
    api.myRepairs().then(ui.myRepairsSuccess).catch(ui.failure);
};
...
module.exports = {
    ...
    onShowMyDevices: onShowMyDevices
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var displayModal = function displayModal(event) {
  event.target.id === "up" ? $(".sign-up-modal").css("display", "block") && $(".sign-in-modal").css("display", "none") : $(".sign-in-modal").css("display", "block") && $(".sign-up-modal").css("display", "none");
};
...
var myDevices = function myDevices() {
    return $.ajax({
...
var editDevice = function editDevice(data, deviceId) {
    return $.ajax({
...
var myRepairs = function myRepairs() {
    return $.ajax({
...
var store = __webpack_require__(2);
var myDevicesTemplate = __webpack_require__(19);
var myRepairsTemplate = __webpack_require__(36);

var myDevicesSuccess = function myDevicesSuccess(data) {
    ...
    var handlebarsTemplate = void 0,
        myDevicesHTML = {};
    for (var key in data) {
        data[key].forEach(function (device) {

            store.user.id == device.user_id ? myDevicesHTML[device.id] = device : '';
...
var addDeviceSuccess = function addDeviceSuccess(data) {
    store.device = data.device;
};

var editDeviceSuccess = function editDeviceSuccess() {
    // Display success to user
};

var myRepairsSuccess = function myRepairsSuccess(data) {
    var handlebarsTemplate = void 0,
        myRepairsHTML = {};
    for (var key in data) {
        data[key].forEach(function (repair_order) {

            store.user.id == repair_order.user_id ? myRepairsHTML[repair_order.id] = repair_order : '';

            store.user.id == repair_order.user_id ? store.repairs.push(repair_order) : '';
        });
    }
    // console.log(store)
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"tmp card\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.model : stack1), depth0))
    + "</li>\n        <li>\n            <b>Serial Number:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.serial_number : stack1), depth0))
    + "\n        </li>\n        <BR />\n        <li>\n            <div class=\"btn-wrapper\">\n                <button id=\"device-minus\" class=\"btn\" type=\"submit\">\n                    <span class=\"glyphicon glyphicon-minus\"></span>\n                </button>\n                <button id=\"device-edit\" class=\"btn\" type=\"submit\">\n                    <span class=\"glyphicon glyphicon-pencil\"></span>\n                </button>\n                <button id=\"device-repair\" class=\"btn btn-default btn-lrg\">\n                    <span class=\"glyphicon glyphicon-wrench\"></span>\n                </button>\n            </div>\n        </li>\n\n\n    </ul>\n    <style>\n        .tmp {\n            background-color: powderblue;\n            max-width: 230px;\n            height: 230px;\n            float: left;\n            margin: 10px 10px;\n            padding: 10px 10px;\n            border-radius: 5px;\n        }\n\n        h3 {\n            padding: 10px 10px;\n            margin: auto 10px;\n        }\n\n        .btn {\n            margin: 0 2% 2% 2%;\n        }\n    </style>\n</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.devices : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"tmp card\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.serial_number : stack1), depth0))
    + "\n        </li>\n        <BR />\n        <li>\n            <b>Complaint:</b> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.complaint : stack1), depth0))
    + "\n        </li>\n\n\n    </ul>\n    <style>\n        .tmp {\n            background-color: powderblue;\n            max-width: 230px;\n            height: 230px;\n            float: left;\n            margin: 10px 10px;\n            padding: 10px 10px;\n            border-radius: 5px;\n        }\n\n        h3 {\n            padding: 10px 10px;\n            margin: auto 10px;\n        }\n\n        .btn {\n            margin: 0 2% 2% 2%;\n        }\n    </style>\n</div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.repair_orders : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
